...
_JSON=$(curl -s https://api.github.com/repos/z8kh8E6t-rEv62qT7/Qv2ray-deps/releases/latest | jq ".assets[] | {browser_download_url, name}" -c | grep "$DEPS_CATEGORY-$DEPS_OS")
